<template>
    <div class="footer">
        <!-- Footer -->
<footer class="page-footer font-small pt-4 footerText" >
  ...
  <div class="container-fluid text-center text-md-left">
    ...
    <div class="row">
      ...
      <div class="col-md-6 mb-md-0 mb-6">
        ...
        <p>1076, 24th Main, 11th Cross, HSR Layout, Bengaluru, Karnataka 560102</p>
